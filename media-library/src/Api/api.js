// We’re using fetch method from fetch API for our AJAX request.
// Fetch returns a promise that resolves to the response to our request.
// We format the response our call elicits via destructured assignment before returning to the store.
